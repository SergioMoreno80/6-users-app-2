...
import { EngineeringOutlined, EventRepeatOutlined } from '@mui/icons-material';
...
export const LendAsset = () => {
  ...
  return (
    ...
    <EventRepeatOutlined color="warning" />
          <Typography variant="h6">Prestamo de Activos</Typography>
        </Box>
