...
export const AssetOut = () => {
  const sucursales = [
    ...
    "Sucursal SLM",
    "Sucursal Tampico",
    "Sucursal Victoria-Satelite",
    "Sucursal Victoria-HGral",
    "Sucursal Victoria-LAPAZ",
  ];
  const departamentos = [
    "Sucursal",
    "Finanzas",
  ...
  const [formData, setFormData] = useState({
    ...
    sucursal: "",
    departamento: "",
    productos: [{ id: 1, nombre: "", cantidad: 0, precio: 0 }],
  });
  ...
  const handleAgregarProducto = () => {
    setFormData({
      ...
      productos: [
        ...formData.productos,
        { id: Date.now(), nombre: "", codigo: "", cantidad: 0, precio: 0 },
      ],
    });
  };
    ...
    >
      ...
      >
        <Box p={2} textAlign="center" bgcolor="#0E0E2C" color="white">
          <MoveDownIcon color="warning" />
          <Typography variant="h6">Baja de Activos</Typography>
        </Box>
